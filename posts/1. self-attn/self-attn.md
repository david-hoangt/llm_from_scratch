...
All code in this post is available as runnable Jupyter notebooks at [github.com/backpropolis/nlp_from_scratch](https://github.com/backpropolis/nlp_from_scratch/tree/main/attention).
...
📓 [Run the full self-attention notebook](https://github.com/backpropolis/nlp_from_scratch/blob/main/attention/1.%20self_attention.ipynb) — includes bidirectional and causal modes with shape checks and attention heatmaps.
...
📓 [Run the multi-head attention notebook](https://github.com/backpropolis/nlp_from_scratch/blob/main/attention/2.%20mutihead_attention.ipynb) — includes per-head visualizations and a detailed single-head vs. multi-head comparison table.
...
📓 Causal attention is covered in the [self-attention notebook](https://github.com/backpropolis/nlp_from_scratch/blob/main/attention/1.%20self_attention.ipynb) — the unified `SelfAttention` class handles both bidirectional and causal modes via an optional mask parameter.
...
📓 [Run the cross-attention notebook](https://github.com/backpropolis/nlp_from_scratch/blob/main/attention/3.%20cross_attention.ipynb) — includes padding mask handling and a translation alignment visualization.
